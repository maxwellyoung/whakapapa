...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        "flex field-sizing-content min-h-24 w-full rounded-xl border border-stone-200 bg-stone-50/50 px-3 py-3 text-base text-stone-900 shadow-sm shadow-stone-900/5 transition-all duration-200 outline-none resize-none",
